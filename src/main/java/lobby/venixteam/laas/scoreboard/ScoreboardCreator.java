...
import lobby.venixteam.laas.utils.StringUtils;
...
public abstract class ScoreboardCreator {
  ...
  public ScoreboardCreator add(int line) {
    return add(line, "");
  }
  
  public ScoreboardCreator add(int line, String name) {
  ...
  public ScoreboardCreator remove(int line) {
    if (line > 15 || line < 1 || this.teams == null) {
      return this;
    }
  ...
  public ScoreboardCreator to(Player player) {
  ...
  public ScoreboardCreator display(String display) {
  ...
  public ScoreboardCreator scroller(ScoreboardScroller ss) {
    this.scroller = ss;
    return this;
  }
  
  public ScoreboardCreator health() {
    this.health = !health;
    if (this.scoreboard != null) {
      if (!this.health) {
  ...
  public ScoreboardCreator healthTab() {
  ...
  public ScoreboardCreator build() {
